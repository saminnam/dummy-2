...
const AboutUs = () => {
  return (
    <section className="relative overflow-hidden">
      <div className="lg:h-[450px] md:h-[500px] h-[1050px] bg-fixed  bg-center bg-[url('https://img.freepik.com/free-photo/construction-works-frankfurt-downtown-germany_1268-20907.jpg')] bg-cover bg-no-repeat w-full">
