...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {/* Desktop Menu */}
      <nav className="hidden lg:w-[430px] lg:flex gap-6 text-[15px] font-medium">
        <Link
          to="/"
      ...
      {isMenuOpen && (
        <div
          className={`z-50 border border-gray-200 absolute left-0 top-24 transition-transform duration-300 w-full bg-white shadow-md p-5 flex flex-col gap-5 lg:hidden ${
