        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 container">
          <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
              <Link to={"/"}>
                <img className="w-[220px] h-[80px]" src={logo} alt="logo" />
              </Link>
            ...
            <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.531733777469!2d80.24056647412192!3d13.065451212815688!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267ab73271a65%3A0x4f3481f3312bbf7c!2sDigital%20Mantraaz!5e0!3m2!1sen!2sin!4v1739855258575!5m2!1sen!2sin"
