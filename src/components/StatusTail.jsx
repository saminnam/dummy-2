...
const StatusTail = () => {
  const { ref, inView } = useInView({
    triggerOnce: true, // Ensures the animation runs only once when visible
  ...
  return (
    <section
      ref={ref}
      className="py-10 bg-white sm:py-16 lg:py-24 bg-[url('https://image.slidesdocs.com/responsive-images/background/black-and-white-illustration-of-the-skyline-of-new-york-powerpoint-background_79daae4640__960_540.jpg')] bg-cover bg-center w-full bg-fixed"
    >
      <div className="grid grid-cols-1 gap-4 px-4 sm:grid-cols-4 sm:px-8">
        ...
        >
          ...
          <div className="px-4 text-gray-700">
            ...
            {inView && (
              <CountUp className="text-3xl" start={0} end={1800} duration={3} />
            )}
          </div>
        </div>
        ...
        >
          ...
          <div className="px-4 text-gray-700">
            ...
            {inView && (
              <CountUp className="text-3xl" start={0} end={600} duration={3} />
            )}
          </div>
        </div>
        ...
        >
          ...
          <div className="px-4 text-gray-700">
            ...
            {inView && (
              <CountUp className="text-3xl" start={0} end={50} duration={3} />
            )}
          </div>
        </div>
      </div>
