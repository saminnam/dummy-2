...
const GlobalTitle = ({ title }) => {
  return (
    <section className="lg:py-20 h-[350px] overflow-hidden lg:px-10 py-10 px-5 bg-global-title">
      <div className="flex flex-col gap-5 h-[240px]  justify-center items-start md:items-center">
        ...
        <nav className="flex bg-[#41404099] px-3 py-2 rounded" aria-label="Breadcrumb">
