...
const OurExpertise = () => {
  return (
    <section className="md:py-20 py-10 overflow-hidden my-10 bg-AboutUs md:px-10 px-5">
        ...
        <div className="flex flex-col gap-10 lg:gap-0 lg:flex-row lg:mt-12">
          ...
          >
            <img
              ...
              src="https://wallpapers.com/images/hd/the-foreman-of-construction-worker-and-the-engineer-82lea69exf414mk2.jpg"
              alt="builder-img"
              loading="lazy"
            />
          </div>
